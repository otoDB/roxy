...
> [!NOTE]
> この記事は [音MAD Advent Calendar 2025](https://adventar.org/calendars/12426) の6日目の投稿として書かれたものです．執筆時の仕様などを書いたものなので，現状の実装とは乖離している可能性があります．正確な詳細は [README.md](../README.md) を参考にしてください．
...
![MADDRIFT2のスプレッドシート](./notes_20251206/maddrift2_spreadsheet.png)
...
![roxyを使ったスプレッドシート](./notes_20251206/roxy_spreadsheet.png)
...
現在7000件ほど音MADが登録されています．全体を考えるとおそらく2~3%程度しか網羅できていないだろうとは言え，そこそこに大きなデータベースとなってきたのではないか，と思っています．

<a href="https://otodb.net/work/random" target="__blank">otoDBに登録されているランダムな作品を見る</a>

![otoDBトップページ](./notes_20251206/otodb_top.png)

[私にMADが舞い降りびゅ～と！](https://www.nicovideo.jp/watch/sm45476124)の関連作品のグラフ: https://otodb.net/work/4832/relations

![otoDB関係ページ](./notes_20251206/otodb_relation.png)
